...
public:
     ...
     */
    enum CheckTime {
        Startup   = (1 << 0), //! Filter at startup befor first the first solution gets computed
        Iteration = (1 << 1), //! Filter each iteration after the equation gets solved for a time step
