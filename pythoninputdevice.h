...
/**
 * @brief The PythonInputDevice class Helper class to construct an istream from an python object.
...
/**
 * @brief The PythonOutputDevice class Helper class to construct an ostream from an python object.
 *        This object must be extend the BaseIO class from python
 */
...
public:
     ...
     * @return True if the data gets flushed successfull
     */
    bool flush() {
